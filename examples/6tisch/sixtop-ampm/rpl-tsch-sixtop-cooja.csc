...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/6tisch/sixtop-ampm/node-sixtop.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>32.78674994158986</x>
        <y>31.257788200660837</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-6.586098602300652</x>
        <y>52.73733741069146</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-39.932061726378784</x>
        <y>69.89604979578922</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>19.763298212107138</x>
        <y>87.46246648096545</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>66.49405251896863</x>
        <y>9.988236064798437</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>79.49949437360696</x>
        <y>-15.821363190445016</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7793176582757664 0.0 0.0 1.7793176582757664 225.25632125171342 75.47744295563675</viewport>
    </plugin_config>
    <width>401</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(12000000);
outputampm = new FileWriter("log_ampm.txt");


while (true) {
    var filter1 = msg.indexOf("APP-AMPM");
    if(id==1 &amp;&amp; filter1&gt;1){
      log.log(time + ":" + id + ":" + msg + "\n");
      outputampm.write(time + " " + msg + "\n");
      outputampm.flush();
    }
 	try{
 		YIELD();
